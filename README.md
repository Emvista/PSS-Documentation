...
`curl -X POST "https://server-pss.prev.io/pss/api/opinions" -H "accept: application/json" -H "Content-Type: application/json" -H "Poa-Token: XXXXXXXX" -d "{\"text\": \"<TEXTE DE PLUS DE 1000 MOTS>\"}"`
...
`curl -X GET "https://server-pss.prev.io/pss/api/opinions/<TOKEN>" -H "accept: application/json" -H "Content-Type: application/json" -H "Poa-Token: XXXXXXXX"`
